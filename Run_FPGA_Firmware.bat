@echo off
title Domesday Duplicator FPGA Firmware Build System
...
rem Startet das MSYS2/MinGW64-Terminal und fuehrt die build_fpga.sh im aktuellen Verzeichnis aus
C:\msys64\msys2_shell.cmd -mingw64 -where "%~dp0" -c "./build_fpga.sh"
